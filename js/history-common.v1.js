// js/history-common.v1.js — helpers shared by history pages
window.MIEC_HIST = (function(){
  ...
  function ensureTable(hostId, headers){
    ...
    // If a table/tbody with id 'rows' already exists, reuse
  ...
  async function getClient(){
    if (window.MIEC_SYNC?.client) return window.MIEC_SYNC.client;
